...
use Ebmt\Models\MSumberDana as MSumberDana ;

class SumberDanaController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $this->setJsonResponse() ;
        	...
        	->columns('id, sumber_dana, status')
        	->from('Ebmt\Models\MSumberDana') 
        	->where("1=1") ;
        	...
        	$sumber_dana_arr          = array();
        	$sumber_dana_arr["total"] = $page->total_items; 
        	
        	foreach($page->items as $item) {
        		$sumber_dana_arr["data"][] = array("id"=>$item->id,
        		                                        "sumber_dana"=>$item->sumber_dana, 
        				                                "status"=>$item->status) ; 
        	}
        	
        	 return $sumber_dana_arr ;
    }
