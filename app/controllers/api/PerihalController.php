...
use Ebmt\Models\MPerihal as MPerihal ;

class PerihalController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $this->setJsonResponse() ;
        	...
        	->columns('id, perihal, status')
        	->from('Ebmt\Models\MPerihal') 
        	->where("1=1") ;
        	...
        	$perihal_arr          = array();
        	$perihal_arr["total"] = $page->total_items; 
        	
        	foreach($page->items as $item) {
        		$perihal_arr["data"][] = array("id"=>$item->id,
