...
class PenerimamanfaatlembagaController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $this->setJsonResponse() ;
        	...
        	->columns('kode_mustahik, no_ktp, nama_kk, nama_pemohon, foto_pemohon, jenis_kelamin,  
        			   ...
        			   kd_negara,kodepos, kode_area_telepon, telepon_rumah, handphone, email, 
        			   tanggal_daftar, keterangan')
        	->from('Ebmt\Models\Mustahik') 
        	->where("SUBSTRING(kode_mustahik,6,2) = '02' AND deleted IS NULL") ;
