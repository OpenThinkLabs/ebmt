...
class KarakterProgramController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $this->setJsonResponse() ;
        	...
        	->columns('id, karakter_program, status')
        	->from('Ebmt\Models\MKarakterProgram') 
        	->where("1=1") ;
        	...
        	$karakter_program_arr          = array();
        	$karakter_program_arr["total"] = $page->total_items; 
        	
        	foreach($page->items as $item) {
        		$karakter_program_arr["data"][] = array("id"=>$item->id,
        		                                        "karakter_program"=>$item->karakter_program, 
        				                                "status"=>$item->status) ; 
        	}
        	
        	 return $karakter_program_arr ;
    }
