 ...
 */
Ext.define('ebmt.view.penerimamanfaat.program.edit.ajuan.tab.Detail', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.penerimamanfaat.program.edit.ajuan.tab.detail',
    layout: 'form',
    autoScroll:true,
	initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                    {
                    	xtype: 'fieldset',
                    	title: 'Ajuan Penerima Manfaat by Program',
                    	defaults: {
                    		layout: 'hbox',
                    		margins: '0 10 0 10'                
                    	},
