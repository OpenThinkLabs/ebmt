/**
 * Main panel for displaying details for {@link ebmt.model.penerimamanfaat.program} records
 */
Ext.define('ebmt.view.penerimamanfaat.program.edit.tab.Detail', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.penerimamanfaat.program.edit.tab.detail',
    layout: 'form',
    overflowY: 'auto',
	initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                    {
                    	xtype: 'fieldset',
                    	title: 'Identitas Penerima Manfaat by Program',
                    	defaults: {
                    		layout: 'hbox',
                    		margins: '0 10 0 10'                
                    	},
