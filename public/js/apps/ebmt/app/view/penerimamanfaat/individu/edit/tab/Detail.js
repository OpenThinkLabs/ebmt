/**
 * Main panel for displaying details for {@link ebmt.model.penerimamanfaat.individu} records
 */
Ext.define('ebmt.view.penerimamanfaat.individu.edit.tab.Detail', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.penerimamanfaat.individu.edit.tab.detail',
    layout: 'form',
    overflowY: 'auto',
	initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                    {
                    	xtype: 'fieldset',
                    	title: 'Identitas Penerima Manfaat Individu',
                    	defaults: {
                    		layout: 'hbox',
                    		margins: '0 10 0 10'                
                    	},
                                ...
                                },
                                {
                                	...
                                	items: [
                                            ...
                                            },
                                	        {
                    						    ...
                    						    store: {
                    						    	type: 'master.jeniskelamin'
                    						    },
                    						    displayField: 'jenis_kelamin',
                    						    valueField: 'kd_jenis_kelamin',
                    						    editable:false,
                        ...
                        items: [
                                ...
                                },
                                {
                                	...
                                	items: [
                    						{
                    						    xtype: 'combobox',
                    						    id: 'kd_propinsi_edit_tab_detail',
                    						    name: 'kd_propinsi',
