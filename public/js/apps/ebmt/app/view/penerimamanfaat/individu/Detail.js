Ext.define('ebmt.view.penerimamanfaat.individu.Detail', {
	extend: 'Ext.window.Window',
	alias: 'widget.penerimamanfaat.individu.detail',
	modal: true,
	bodyPadding:10,
	width: 800,
	minHeight:600,
			...
			tpl: Ext.create('Ext.XTemplate', 
				'<table cellpadding="0" cellspacing="0" border="0" style="width:100%">',
					'<tr>',
						...
						'<td>',
						    '<fieldset>',
						      '<legend>Identitas Penerima Manfaat Individu</legend>',
								'<table cellpadding="0" cellspacing="0" border="0" style="width:100%">',
								'<tr>',
								  '<td style="width:20%"><strong>No KTP</strong></td><td style="width:10px">:</td><td style="width:30%">{no_ktp}</td>',
								  '<td style="width:20%"><strong>No Kartu Keluarga</strong></td><td style="width:10px">:</td><td style="width:30%">{no_kk}</td>',
								'</tr>',
								'<tr>',
								  '<td style="width:20%"><strong>Nama Pemohon</strong></td><td style="width:10px">:</td><td style="width:30%">{nama_pemohon}</td>',
								  '<td style="width:20%"><strong>Jenis Kelamin</strong></td><td style="width:10px">:</td><td style="width:30%">{txt_jenis_kelamin}</td>',
								'</tr>',
								'<tr>',
								  '<td style="width:20%"><strong>Nama Kepala Keluarga</strong></td><td style="width:10px">:</td><td style="width:30%">{nama_kk}</td>',
								  '<td style="width:20%">&nbsp;</td><td style="width:10px">&nbsp;</td><td style="width:30%">&nbsp;</td>',
								'</tr>',								
								'</table>',
							'</fieldset>',
						    '<fieldset>',
