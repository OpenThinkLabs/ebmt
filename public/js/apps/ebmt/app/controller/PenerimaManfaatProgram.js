Ext.define('ebmt.controller.PenerimaManfaatProgram', {
    extend: 'ebmt.controller.Base',
    stores: [
             'ebmt.store.penerimamanfaat.Programs',
    ...
    views: [
              'penerimamanfaat.program.List',
              'penerimamanfaat.program.edit.Form',
              'penerimamanfaat.program.edit.Window',
              'penerimamanfaat.program.search.Form',
              'penerimamanfaat.program.search.Window',
              'penerimamanfaat.program.Detail',
              'penerimamanfaat.program.edit.tab.Ajuan',
              'penerimamanfaat.program.edit.ajuan.Window'
    ],
    refs: [
    {
      ref: 'PenerimaManfaatProgramList',
      selector: '[xtype=penerimamanfaat.program.list]'
    },
    {
      ref: 'PenerimaManfaatProgramEditWindow',
      selector: '[xtype=penerimamanfaat.program.edit.window]'
    },
    {
      ref: 'PenerimaManfaatProgramEditForm',
      selector: '[xtype=penerimamanfaat.program.edit.form]'
    },
    {
        ref: 'PenerimaManfaatProgramSearchWindow',
        selector: '[xtype=penerimamanfaat.program.search.window]'
    },
    {
        ref: 'PenerimaManfaatProgramSearchForm',
        selector: '[xtype=penerimamanfaat.program.search.form]'
    },
    {
        ref: 'PenerimaManfaatProgramFotoView',
        selector: '[xtype=penerimamanfaat.program.edit.tab.foto]'
    },    
    {
        ref: 'PenerimaManfaatProgramDetailWindow',
        selector: '[xtype=penerimamanfaat.program.detail]'
    },
    {
        ref: 'PenerimaManfaatProgramEditAjuanWindow',
        selector: '[xtype=penerimamanfaat.program.edit.ajuan.window]'
    },
    {
        ref: 'PenerimamanfaatProgramEditTabAjuan',
        selector: '[xtype=penerimamanfaat.program.edit.tab.ajuan]'
    }        
    ],
    init: function() {        
    	this.listen({
    		controller: {},
    		component: {
    			'grid[xtype=penerimamanfaat.program.list]': {
   			      beforerender: this.loadRecords,
   			      itemdblclick: this.edit,
   			      itemcontextmenu: this.showContextMenu
 			    }, 
 			    'grid[xtype=penerimamanfaat.program.list] button#tambah': {
 			       click: this.add	
 			     },
  	            'grid[xtype=penerimamanfaat.program.list] button#search': {
 	                click: this.showSearch
 	            },
 	            'grid[xtype=penerimamanfaat.program.list] button#clear': {
 	                click: this.clearSearch
 	            },
 	            'form[xtype=penerimamanfaat.program.edit.form] button#upload': {
 	                click: this.upload
 	            }, 	             	            
 			    'window[xtype=penerimamanfaat.program.edit.window] button#simpan':{
 			       click: this.save
 			    },
 			    'window[xtype=penerimamanfaat.program.edit.window] button#batal':{
 	 			   click: this.close
 	 			},
 	            'window[xtype=penerimamanfaat.program.search.window] button#cari': {
 	                click: this.search
 	            },
 	            'window[xtype=penerimamanfaat.program.search.window] button#batal': {
 	                click: this.close
 	            },
 	            '[xtype=penerimamanfaat.program.edit.tab.foto] dataview': {
 	            	itemcontextmenu: this.showFotoContextMenu
 	            },
  			    'grid[xtype=penerimamanfaat.program.edit.tab.ajuan]': {
  			    	beforerender: this.loadRecordsAjuan,
  			    	itemdblclick: this.editAjuan,
  			    	itemcontextmenu: this.showContextMenuAjuan
    			},  			      	            
 			    'grid[xtype=penerimamanfaat.program.edit.tab.ajuan] button#tambah': {
  			       click: this.addAjuan	
  			    },
   	            'grid[xtype=penerimamanfaat.program.edit.tab.ajuan] button#search': {
  	                click: this.showSearchAjuan
  	            },
  	            'grid[xtype=penerimamanfaat.program.edit.tab.ajuan] button#clear': {
  	                click: this.clearSearchAjuan
  	            },
 			    'window[xtype=penerimamanfaat.program.edit.ajuan.window] button#simpan':{
  			       click: this.saveAjuan
  			    },
  			    'window[xtype=penerimamanfaat.program.edit.ajuan.window] button#batal':{
    ...
    */
    clearSearch: function( button, e, eOpts ) {
        var me = this,
            grid = me.getPenerimaManfaatProgramList(),
            store = grid.getStore();
        // clear filter
     ...
     */
     clearSearchAjuan: function( button, e, eOpts ) {
    	 ...
    	 /**
         var me = this,
             grid = me.getPenerimamanfaatProgramEditTabAjuan(),
             store = grid.getStore();
    ...
    */
    showSearch: function( button, e, eOpts ) {
        var me = this,
            win = me.getPenerimaManfaatProgramSearchWindow();
        // if window exists, show it; otherwise, create new instance
        if( !win ) {
            win = Ext.widget( 'penerimamanfaat.program.search.window', {
                title: 'Cari Penerima Manfaat Program'
            });
        }
        // show window
        win.show();
    ...
    */
    ...
    add: function( button, e, eOpts ) {
        var me = this,
            record = Ext.create( 'ebmt.model.penerimamanfaat.Program' );
    ...
    save: function( button, e, eOpts ) {
        ...
        Ext.getBody().mask( 'Simpan Data Penerima Manfaat Program...' );
    ...
    showEditWindow: function( record ) {
        var me = this,
            win = me.getPenerimaManfaatProgramEditWindow(),
            isNew = record.phantom;

        // if window exists, show it; otherwise, create new instance
        if( !win ) {
            win = Ext.widget( 'penerimamanfaat.program.edit.window', {
                title: isNew ? 'Tambah Penerima Manfaat by Program Baru' : 'Edit Penerima Manfaat by Program'
            });
        }
        // show window
        win.show();
    ...
    showEditWindowAjuan: function( record , kode_mustahik) {
        var me = this,
            win = me.getPenerimaManfaatProgramEditAjuanWindow(),
            isNew = record.phantom;

        // if window exists, show it; otherwise, create new instance
        if( !win ) { 
            win = Ext.widget( 'penerimamanfaat.program.edit.ajuan.window', {
                title: isNew ? 'Tambah Ajuan Baru Penerima Manfaat by Program' : 'Edit Ajuan Penerima Manfaat by Program'
            });
        }
        // show window
        win.show();
    ...
    /**
    * Displays details window for selected penerima manfaat program
    * @param {Ext.data.Model} record
    */
    showDetailWindow: function( record ) {
        var me = this,
            win = me.getPenerimaManfaatProgramDetailWindow();
        // if window exists, show it; otherwise, create new instance
        if( !win ) {
            win = Ext.widget( 'penerimamanfaat.program.detail', {
                title: 'Detail Informasi Penerima Manfaat Program'
            });
        }
        // show window
        win.show();
    ...
    */
    upload: function( button, e, eOpts ) {
        var me = this,
            ...
            record = form.getRecord(),
            view = me.getPenerimaManfaatProgramFotoView().down( 'dataview' ),
        ...
        // submit form
        uploadform.submit({
            url: '/api/PenerimaManfaatProgram?act=upload_foto',
            params: {
