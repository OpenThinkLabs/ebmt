 ...
 */
Ext.define('ebmt.controller.Workflows', {
    ...
    loadWorkflowHistory: function( grid, eOpts ) {
        ...
        store.getProxy().url = '/api/Workflows?kode_mustahik=' + grid.kode_mustahik;
        store.load();
    },
    /**
    ...
    showHistory: function( view, record, item, index, e, eOpts ) {
        ...
        Ext.create('Ext.window.Window', {
            ...
            items: [
                {
                    xtype: 'workflow.list',
                    kode_mustahik: record.get( 'kode_mustahik' )
                }
            ]
        }).show();
    },
        ...
        Ext.Msg.show({
            ...
            fn: function( buttonId, text, opt ){
                if( buttonId=='ok' ) {
                    ...
                    Ext.Ajax.request({
                        url: '/api/Workflows?kode_mustahik=' + record.get( 'kode_mustahik' ),
                        method: 'PUT',
                        params: {
