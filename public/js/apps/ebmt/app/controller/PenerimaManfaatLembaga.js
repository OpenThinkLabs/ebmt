Ext.define('ebmt.controller.PenerimaManfaatLembaga', {
    extend: 'ebmt.controller.Base',
    stores: [
             'ebmt.store.penerimamanfaat.Lembagas',
    ...
    views: [
              'penerimamanfaat.lembaga.List',
              'penerimamanfaat.lembaga.edit.Form',
              'penerimamanfaat.lembaga.edit.Window',
              'penerimamanfaat.lembaga.search.Form',
              'penerimamanfaat.lembaga.search.Window',
              'penerimamanfaat.lembaga.Detail',
              'penerimamanfaat.lembaga.edit.tab.Ajuan',
              'penerimamanfaat.lembaga.edit.ajuan.Window'
    ],
    refs: [
    {
      ref: 'PenerimaManfaatLembagaList',
      selector: '[xtype=penerimamanfaat.lembaga.list]'
    },
    {
      ref: 'PenerimaManfaatLembagaEditWindow',
      selector: '[xtype=penerimamanfaat.lembaga.edit.window]'
    },
    {
      ref: 'PenerimaManfaatLembagaEditForm',
      selector: '[xtype=penerimamanfaat.lembaga.edit.form]'
    },
    {
        ref: 'PenerimaManfaatLembagaSearchWindow',
        selector: '[xtype=penerimamanfaat.lembaga.search.window]'
    },
    {
        ref: 'PenerimaManfaatLembagaSearchForm',
        selector: '[xtype=penerimamanfaat.lembaga.search.form]'
    },
    {
        ref: 'PenerimaManfaatLembagaFotoView',
        selector: '[xtype=penerimamanfaat.lembaga.edit.tab.foto]'
    },    
    {
        ref: 'PenerimaManfaatLembagaDetailWindow',
        selector: '[xtype=penerimamanfaat.lembaga.detail]'
    },
    {
        ref: 'PenerimaManfaatLembagaEditAjuanWindow',
        selector: '[xtype=penerimamanfaat.lembaga.edit.ajuan.window]'
    },
    {
        ref: 'PenerimamanfaatLembagaEditTabAjuan',
        selector: '[xtype=penerimamanfaat.lembaga.edit.tab.ajuan]'
    }        
    ],
    init: function() {        
    	this.listen({
    		controller: {},
    		component: {
    			'grid[xtype=penerimamanfaat.lembaga.list]': {
   			      beforerender: this.loadRecords,
   			      itemdblclick: this.edit,
   			      itemcontextmenu: this.showContextMenu
 			    }, 
 			    'grid[xtype=penerimamanfaat.lembaga.list] button#tambah': {
 			       click: this.add	
 			     },
  	            'grid[xtype=penerimamanfaat.lembaga.list] button#search': {
 	                click: this.showSearch
 	            },
 	            'grid[xtype=penerimamanfaat.lembaga.list] button#clear': {
 	                click: this.clearSearch
 	            },
 	            'form[xtype=penerimamanfaat.lembaga.edit.form] button#upload': {
 	                click: this.upload
 	            }, 	             	            
 			    'window[xtype=penerimamanfaat.lembaga.edit.window] button#simpan':{
 			       click: this.save
 			    },
 			    'window[xtype=penerimamanfaat.lembaga.edit.window] button#batal':{
 	 			   click: this.close
 	 			},
 	            'window[xtype=penerimamanfaat.lembaga.search.window] button#cari': {
 	                click: this.search
 	            },
 	            'window[xtype=penerimamanfaat.lembaga.search.window] button#batal': {
 	                click: this.close
 	            },
 	            '[xtype=penerimamanfaat.lembaga.edit.tab.foto] dataview': {
 	            	itemcontextmenu: this.showFotoContextMenu
 	            },
  			    'grid[xtype=penerimamanfaat.lembaga.edit.tab.ajuan]': {
  			    	beforerender: this.loadRecordsAjuan,
  			    	itemdblclick: this.editAjuan,
  			    	itemcontextmenu: this.showContextMenuAjuan
    			},  			      	            
 			    'grid[xtype=penerimamanfaat.lembaga.edit.tab.ajuan] button#tambah': {
  			       click: this.addAjuan	
  			    },
   	            'grid[xtype=penerimamanfaat.lembaga.edit.tab.ajuan] button#search': {
  	                click: this.showSearchAjuan
  	            },
  	            'grid[xtype=penerimamanfaat.lembaga.edit.tab.ajuan] button#clear': {
  	                click: this.clearSearchAjuan
  	            },
 			    'window[xtype=penerimamanfaat.lembaga.edit.ajuan.window] button#simpan':{
  			       click: this.saveAjuan
  			    },
  			    'window[xtype=penerimamanfaat.lembaga.edit.ajuan.window] button#batal':{
    ...
    */
    clearSearch: function( button, e, eOpts ) {
        var me = this,
            grid = me.getPenerimaManfaatLembagaList(),
            store = grid.getStore();
        // clear filter
     ...
     */
     clearSearchAjuan: function( button, e, eOpts ) {
    	 ...
    	 /**
         var me = this,
             grid = me.getPenerimamanfaatLembagaEditTabAjuan(),
             store = grid.getStore();
    ...
    */
    showSearch: function( button, e, eOpts ) {
        var me = this,
            win = me.getPenerimaManfaatLembagaSearchWindow();
        // if window exists, show it; otherwise, create new instance
        if( !win ) {
            win = Ext.widget( 'penerimamanfaat.lembaga.search.window', {
                title: 'Cari Penerima Manfaat Lembaga'
            });
        }
        // show window
        win.show();
    ...
    */
    ...
    add: function( button, e, eOpts ) {
        var me = this,
            record = Ext.create( 'ebmt.model.penerimamanfaat.Lembaga' );
    ...
    save: function( button, e, eOpts ) {
        ...
        Ext.getBody().mask( 'Simpan Data Penerima Manfaat Lembaga...' );
    ...
    showEditWindowAjuan: function( record , kode_mustahik) {
        var me = this,
            win = me.getPenerimaManfaatLembagaEditAjuanWindow(),
            isNew = record.phantom;

        // if window exists, show it; otherwise, create new instance
        if( !win ) { 
            win = Ext.widget( 'penerimamanfaat.lembaga.edit.ajuan.window', {
                title: isNew ? 'Tambah Ajuan Baru Penerima Manfaat Lembaga' : 'Edit Ajuan Penerima Manfaat Lembaga'
            });
        }
        // show window
        win.show();
    ...
    /**
    * Displays details window for selected penerima manfaat lembaga
    * @param {Ext.data.Model} record
    */
    showDetailWindow: function( record ) {
        var me = this,
            win = me.getPenerimaManfaatLembagaDetailWindow();
        // if window exists, show it; otherwise, create new instance
        if( !win ) {
            win = Ext.widget( 'penerimamanfaat.lembaga.detail', {
                title: 'Detail Informasi Penerima Manfaat Lembaga'
            });
        }
        // show window
        win.show();
    ...
    */
    upload: function( button, e, eOpts ) {
        var me = this,
            ...
            record = form.getRecord(),
            view = me.getPenerimaManfaatLembagaFotoView().down( 'dataview' ),
        ...
        // submit form
        uploadform.submit({
            url: '/api/PenerimaManfaatLembaga?act=upload_foto',
            params: {
